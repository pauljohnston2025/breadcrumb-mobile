...
class TileServerRepo(private val webServerController: WebServerController) {
    ...
    val availableServers = MutableStateFlow(listOf(
        ...
        TileServerInfo(ServerType.ESRI, "Esri - World Boundaries and Places", "https://server.arcgisonline.com/arcgis/rest/services/Reference/World_Boundaries_and_Places/MapServer/tile/{z}/{y}/{x}", 0, 19),
        TileServerInfo(ServerType.ESRI, "Esri - World Boundaries and Places Alternate", "https://server.arcgisonline.com/arcgis/rest/services/Reference/World_Boundaries_and_Places_Alternate/MapServer/tile/{z}/{y}/{x}", 0, 11),
