        ...
        androidx.compose.material.Surface(
            ...
            Column(modifier = Modifier.fillMaxSize()) {
                ...
                ModalDrawer(
                    ...
                    val selectedAppName =
                        IConnection.availableConnectIqApps.find { it.id == connectIqAppId }?.name
                            ?: "App"
                    ...
                    Scaffold(
                            ...
                            TopAppBar(
                                ...
                                title = { // Use a Column to stack two Text composables vertically
                                    Column {
                                        ...
                                        val subtitle =
                                            deviceSelector.currentDevice.value?.let { device ->
                        ...
                        snackbarHost = { SnackbarHost(hostState = scaffoldState.snackbarHostState) }) { paddingValues -> // Content receives padding from Scaffold
...
//                    }
                                ...
                                composable(Screen.Settings.route) {
                                    @SuppressLint("StateFlowValueCalledInComposition") val currentColourPaletteEdit =
                                        mapViewModel.newlyCreatedPalette.value
                                ...
                                composable(Screen.Devices.route) {
                                    DeviceSelector(
                                        viewModel = deviceSelector, false
                                    )
                                }

                                composable(Screen.DeviceSelection.route) {
                                    DeviceSelector(
                                        viewModel = deviceSelector, true
                                    )
                                }
